...
logger.add('logs/ml_pipeline_finance_deep2.log', level='INFO', rotation='10 MB', encoding='utf-8')
...
def preparar_dados(caminho_arquivo, features_desejadas, janela_anos=None):
    ...
    if janela_anos is not None:
        ...
        logger.info(f"Usando janela de {janela_anos} para treinamento")
    ...
    logger.info(f"Dropadas {linhas_antes - linhas_depois} linhas com NaNs em features/Target")
...
if __name__ == "__main__":
    ...
    for arquivo in tqdm(arquivos, desc="Treinando arquivos"):
        try:
            ...
            model_final, losses, accuracies, aucs = treinar_modelo_dl(model_final, optimizer_final, criterion_final, train_loader, val_loader)
